...
const App: React.FC = () => {
    ...
    const handleGeneratePrompt = useCallback(async (request: AppIdeaRequest) => {
        setIsLoading(true);
        setError(null);
        setGeneratedPrompt('');
            ...
            <main className="container mx-auto px-4 py-8">
                <div className="max-w-3xl mx-auto">
                    <p className="text-center text-lg text-slate-400 mb-8">
                        Introduce un campo, industria o profesión. La IA identificará un problema y generará un concepto de app en formato C.R.P.A.T.
                    </p>
